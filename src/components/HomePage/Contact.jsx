  ...
  return (
    <>
     ...
     <div className="mt-8">
      ...
      <div className="w-[50%]">
      <div className="mt-8">
          <h2 className="text-2xl font-bold text-prime">Contact Form</h2>
          <form onSubmit={handleSubmit} className=" bg-gray-300 p-4 mt-4 rounded-md">
            <Slide top duration={2000} className="mb-4">
              <label className="block text-prime">{data.contactForm.name}</label>
              <input
                type="text"
                name="name"
                value={formData.name}
            ...
            <Slide top duration={2000} className="mb-4">
              <label className="block text-prime">{data.contactForm.email}</label>
              <input
                type="email"
                name="email"
            ...
            <Slide top duration={2000} className="mb-4">
              <label className="block text-prime">{data.contactForm.message}</label>
              <textarea
                name="message"
            ...
            <button
              type="submit"
              className="px-6 py-2 bg-blue-500 text-prime rounded-md mt-4"
            >
