    ...
    <>
      ...
      <div className="bg-gray-100 py-12 px-4">
        ...
        <section className="container mx-auto">
          <div className="bg-white rounded-lg shadow-lg p-8 flex flex-col md:flex-row items-center justify-center md:justify-between space-y-6 md:space-y-0 md:space-x-8">
            <div className="w-full md:w-1/2">
              <h2 className="text-3xl font-bold text-gray-800 mb-4">
            ...
            <div className="w-full md:w-1/2 flex sm:justify-end">
              <Slide bottom duration={2000}>
                <img
